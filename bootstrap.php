...
if (!isUserLoggedIn()) {
    ...
    if ($current_file != 'home.php' && $current_file != 'user.php' && $current_file != 'api.php' && $current_file != 'create.php' && $current_file != 'notification.php' && $current_file != 'edit_profile.php') {
