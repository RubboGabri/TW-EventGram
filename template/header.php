...
<header class="d-md-none fixed-top border-bottom border-dark bg-info d-flex justify-content-between align-items-center" style="height: 7vh;">
    ...
    switch ($firstWord) {
        case 'EventGram':
            ...
            echo '    <span id="unread-notifications" class="badge rounded-pill bg-danger position-absolute d-none" style="top: 0; right: 0; font-size: 0.8rem; padding: 3px 6px;"></span>';
            echo '</a>';
            break;
