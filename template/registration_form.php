<div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="col-12 col-md-8 col-lg-6 p-5 text-center">
            <form action="#" method="POST" class="p-0 m-0">
                ...
                <div class="form-group mb-3">
                    <label for="confirm_password" class="fs-6 fw-semibold d-block text-start">Conferma Password:</label>
            ...
            <section class="mt-4">
                ...
                <div class="mt-3">
                    <a href="index.php" class="btn btn-primary" style="border-radius: 25px">Accedi</a>
                </div>
            </section> 
        </div>
    </div>